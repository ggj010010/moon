...
<h1 class="title">${roomDetail.r_name }</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="resources/roomFileUpload/${roomDetail.r_img }" class="img-responsive" alt="slide"></div>
                </div>
                <!-- Controls -->
...
<div class="room-features spacer">
  <div class="row">
	...
	<p>${roomDetail.r_com }</p>
    </div>
    </div>  
    <div class="col-sm-3 col-md-2">
      <div class="size-price">Price<span><fmt:formatNumber value="${roomDetail.r_price }" type="currency" currencySymbol="\\"
