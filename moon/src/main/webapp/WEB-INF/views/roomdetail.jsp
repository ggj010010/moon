...
<h1 class="title">Luxirious Suites</h1>
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="assets/images/photos/8.jpg" class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="assets/images/photos/9.jpg"  class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="assets/images/photos/10.jpg"  class="img-responsive" alt="slide"></div>
                </div>
                <!-- Controls -->
